...
export default function Sucursales() {
  ...
  useEffect(() => {
    getSucursales().then(setSucursales).catch(e => setError(e.message));
  }, []);
            ...
            <div className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="font-semibold text-slate-800 group-hover:text-rose-600 transition-colors">{s.nombre}</h3>
                  <p className="text-sm text-slate-500">{s.ciudad}</p>
