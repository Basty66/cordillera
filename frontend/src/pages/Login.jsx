    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <div className="relative">
              <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl shadow-2xl shadow-emerald-500/30 flex items-center justify-center rotate-3">
          ...
          <motion.p
            ...
            className="text-emerald-400/70 text-sm mt-1 font-medium tracking-wide"
          >
        ...
        >
          ...
          <div className="relative glass-dark rounded-2xl shadow-2xl p-8 border border-white/10">
            {/* Header */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <motion.div
                  animate={errors.username ? { x: [0, -4, 4, -4, 4, 0] } : {}}
                ...
                >
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-white/10 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${
              ...
              <div>
                ...
                >
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-12 bg-white/10 border rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-emerald-600/30 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
              >
                {loading ? (
                  <motion.div
                    animate={{ rotate: 360 }}
              ...
              <div className="grid grid-cols-3 gap-2">
                {demoUsers.map(d => (
                  <motion.button
                    ...
                    className="p-2.5 bg-white/5 hover:bg-white/10 rounded-xl text-center transition-all border border-white/5 hover:border-white/10"
                  >
                    <div className={`w-7 h-7 bg-gradient-to-br ${d.color} rounded-lg mx-auto mb-1.5 flex items-center justify-center`}>
